        ...
        <div class="col-sm-8">
          ...
          <div class="row">
            <div class="col">
              ...
              <input id="data_nascimento" name="data_nascimento" type="number" class="form-control" placeholder="Data de nascimento">
            </div>
            <div class="col">
              <label for="data_cliente">Preço de venda</label>
              <input id="data_cliente" name="data_cliente" type="number" class="form-control" placeholder="Inicio da fidelidade">
            </div>
          </div>
          <br>
          <div class="row">
          ...
          <div class="row">
            <div class="col">
              ...
              <input id="estado_produto" name="estado_produto" type="text" class="form-control" placeholder="Cidade">
            </div>
            <div class="col">
              <label for="quantidade_produto">Quantidade</label>
              <input id="quantidade_produto" name="quantidade_produto" type="text" class="form-control" placeholder="Cidade">
            </div>
          </div>
          <br>
          <br>
