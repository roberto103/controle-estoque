...
$salvar = $pdo->prepare('UPDATE produtos SET modelo = :modelo, valor_compra = :valor_compra, valor_venda = :valor_venda, imei = :imei, numero_serie = :numero_serie, estado_produto = :estado_produto WHERE id = :id');
