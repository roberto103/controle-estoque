...
<div class="wrapper">
        ...
        <div class="col-sm-8">
          ...
          <div class="row">
            <div class="col">
              ...
              <input id="data_nascimento" name="data_nascimento" type="date" class="form-control" placeholder="First name">
            </div>
            <div class="col">
              <label for="data_cliente">Inicio da fidelidade</label>
              <input id="data_cliente" name="data_cliente" type="date" class="form-control" placeholder="Last name">
            </div>
          </div>
          <br>
          <div class="row">
            <div class="col">
              ...
              <input id="cidade_cliente" name="cidade_cliente" type="text" class="form-control" placeholder="First name">
            </div>
            <div class="col">
              <label for="bairro_cliente">Bairro</label>
              <input id="bairro_cliente" name="bairro_cliente" type="text" class="form-control" placeholder="Last name">
            </div>
          </div>
          <br>
          <div class="row" style="margin-left:0.1%;">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 - <a href="http://adminlte.io">i9 Soft</a>.</strong>
